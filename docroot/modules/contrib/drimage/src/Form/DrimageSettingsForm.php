...
class DrimageSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['imageapi_optimize_webp'] = [
      ...
      '#description' => $this->t('This options is only available if <a href="https://www.drupal.org/project/imageapi_optimize_webp">imageapi_optimize_webp</a> module is installed. and a "Sitewide default pipeline" is set up. You might need to flush the image cache (drush if) after enabling this option.'),
