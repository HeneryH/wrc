...
class ComponentTaggingController extends ControllerBase {
   ...
   *   The component tag manager.
   */
  public function __construct(ConfigFactoryInterface $config_factory, ComponentTagPluginManager $component_tag_manager, ComponentPluginManager $component_manager) {
  ...
  public function __invoke() {
    ...
    $default_values = array_reduce(
      ...
      function(array $carry, array $item) {
        $tag_id = $item['tag_id'];
        unset($item['tag_id']);
        $components = \Drupal::service(NoThemeComponentManager::class)
