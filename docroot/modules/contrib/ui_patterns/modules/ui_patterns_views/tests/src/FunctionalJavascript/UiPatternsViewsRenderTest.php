...
class UiPatternsViewsRenderTest extends WebDriverTestBase {
  ...
  public function testUiPatternsViewsRendering() {
    ...
    $suggestions = [
      'pattern-teaser-wrapper--variant-default.html.twig',
      'pattern-teaser-wrapper.html.twig',
    ];
    ...
    $assert_session->elementContains('css', 'h2.teaser-wrapper-title', 'Test article');
