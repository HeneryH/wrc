...
class CRM_CiviDiscount_Form_Admin extends CRM_Admin_Form {
  ...
  public function setDefaultValues() {
    ...
    $defaults['is_active'] = $origID ? ($defaults['is_active'] ?? NULL) : 1;
    $defaults['autodiscount_active_only'] = $origID ? ($defaults['autodiscount_active_only'] ?? NULL) : 1;
    $defaults['discount_msg_enabled'] = $origID ? ($defaults['discount_msg_enabled'] ?? NULL) : 0;
  ...
  public function postProcess() {
    ...
    if (!empty($params['advanced_autodiscount_filter_entity'])) {
      $this->addAdvancedFilterToAutodiscount($params, $params['advanced_autodiscount_filter_entity'], $params['advanced_autodiscount_filter_string'] ?? NULL);
    }
