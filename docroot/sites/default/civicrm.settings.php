...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupal:WRC%23winning@mariadb-wrc.lxd:3306/varbase?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'https://www.warringtonrepublicans.org//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/var/www/varbase/docroot/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests') {
    ...
    define('CIVICRM_DSN', 'mysql://drupal:WRC%23winning@mariadb-wrc.lxd:3306/varbase?new_link=true');
  }
}
...
$civicrm_root = '/var/www/varbase/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/varbase/private/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://www.warringtonrepublicans.org');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '1IYyxyAPqCjIYukesQMWJXsQKKOkiVdnw8cFZglqjU');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:jKyThtzHN8Yg68o9uA9X3J0Gfx0WptyS7zk3QHzVlAttnsCA');
...
if (!defined('CIVICRM_DEPLOY_ID') ) {
  define( '_CIVICRM_DEPLOY_ID', 'nZhBSj3VmedmtQ');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:i6hN4OJ1mgc9AmsrY1hZ8ZfyzAq1Y8S3Foaj1uHkeCdfAklXRLTEg');
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/varbase/private/civicrm/templates_c/mail.log');
// }
