 ...
 * @endcode
 */
$settings['hash_salt'] = 'kQOUx3iO9AAEHaZtyUzxnxbD1D_Y5v2dZzo13VyLT-eU8W5VmjbkTXB7l6knjmwDkV_famHrtA';
...
$settings['config_sync_directory'] = '/var/www/varbase/config/sync';
$settings['file_private_path'] = '/var/www/varbase/private';
$settings['trusted_host_patterns'] = [
   '^warringtonrepublicans\.org$',
   '^.+\.warringtonrepublicans\.org$',
 ];
$settings['reverse_proxy'] = TRUE;
$settings['reverse_proxy_addresses'] = array('10.137.172.56');

$databases['default']['default'] = array (
  'database' => 'varbase',
  'username' => 'drupal',
  'password' => 'WRC#winning',
  'prefix' => '',
  'host' => 'mariadb-wrc.lxd',
  'port' => '3306',
