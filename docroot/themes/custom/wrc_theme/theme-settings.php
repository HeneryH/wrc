 ...
 * theme-settings.php
 *
 * Provides theme settings for WRC GOP Theme
 */
 ...
 */
function wrc_theme_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  foreach ($wrc_theme_contained_regions as $contained_region_name => $contained_region_title) {
