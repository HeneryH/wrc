...
">
            ...
            <td><a href="<?php echo smarty_function_crmURL(array('p' => 'civicrm/contact/view','q' => "reset=1&cid=".($this->_tpl_vars['row']['contact_id'])."&key=".($this->_tpl_vars['qfKey'])."&context=".($this->_tpl_vars['context'])), $this);?>
