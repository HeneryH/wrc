...
<div id="commPrefs" class="crm-accordion-body">
    <table class="form-layout-compressed" >
        <?php if (array_key_exists ( 'communication_style_id' , $this->_tpl_vars['form'] )): ?>
          <tr><td colspan='4'>
 ...
 <?php echo smarty_function_help(array('id' => "id-communication_style",'file' => "CRM/Contact/Form/Contact.hlp"), $this);?>
        ...
        <?php endif; ?>
        <tr>
          <?php if (array_key_exists ( 'email_greeting_id' , $this->_tpl_vars['form'] )): ?>
            <td><?php echo $this->_tpl_vars['form']['email_greeting_id']['label']; ?>
</td>
          <?php endif; ?>
          <?php if (array_key_exists ( 'postal_greeting_id' , $this->_tpl_vars['form'] )): ?>
            <td><?php echo $this->_tpl_vars['form']['postal_greeting_id']['label']; ?>
</td>
          <?php endif; ?>
          <?php if (array_key_exists ( 'addressee_id' , $this->_tpl_vars['form'] )): ?>
            <td><?php echo $this->_tpl_vars['form']['addressee_id']['label']; ?>
</td>
          <?php endif; ?>
          <?php if (array_key_exists ( 'email_greeting_id' , $this->_tpl_vars['form'] ) || array_key_exists ( 'postal_greeting_id' , $this->_tpl_vars['form'] ) || array_key_exists ( 'addressee_id' , $this->_tpl_vars['form'] )): ?>
        ...
        <tr>
          <?php $_from = $this->_tpl_vars['commPreference']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
