...
<?php if ($this->_tpl_vars['className'] == 'CRM_Contact_Form_Contact' && $this->_tpl_vars['title']): ?>
...
"<?php endif; ?>>
  ...
  <table class="form-layout-compressed crm-edit-address-form">
     <?php if ($this->_tpl_vars['masterAddress'] && $this->_tpl_vars['masterAddress'][$this->_tpl_vars['blockId']] > 0): ?>
...
" class="form-layout-compressed">
                  <?php $_from = $this->_tpl_vars['addressSequence']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
