...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if ($this->_tpl_vars['products']): ?>
  <div id="premiums" class="premiums-group">
    ...
    <?php echo '<div id="premiums-listings">'; ?><?php if ($this->_tpl_vars['showPremium'] && ! $this->_tpl_vars['preview'] && $this->_tpl_vars['premiumBlock']['premiums_nothankyou_position'] == 1): ?><?php echo '<div class="premium premium-no_thanks" id="premium_id-no_thanks" min_contribution="0"><div class="premium-short"><input type="checkbox" disabled="disabled" /> '; ?><?php echo $this->_tpl_vars['premiumBlock']['premiums_nothankyou_label']; ?><?php echo '</div><div class="premium-full"><input type="checkbox" checked="checked" disabled="disabled" /> '; ?><?php echo $this->_tpl_vars['premiumBlock']['premiums_nothankyou_label']; ?><?php echo '</div></div>'; ?><?php endif; ?><?php echo ''; ?><?php $_from = $this->_tpl_vars['products']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
