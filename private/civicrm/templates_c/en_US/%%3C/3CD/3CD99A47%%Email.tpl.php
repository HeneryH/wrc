<?php /* Smarty version 2.6.32, created on 2023-08-23 09:54:54
         compiled from CRM/Contact/Page/Inline/Email.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/Inline/Email.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Page/Inline/Email.tpl', 12, false),array('function', 'privacyFlag', 'CRM/Contact/Page/Inline/Email.tpl', 22, false),array('function', 'crmURL', 'CRM/Contact/Page/Inline/Email.tpl', 41, false),array('function', 'crmAPI', 'CRM/Contact/Page/Inline/Email.tpl', 48, false),array('modifier', 'truncate', 'CRM/Contact/Page/Inline/Email.tpl', 49, false),array('modifier', 'crmDate', 'CRM/Contact/Page/Inline/Email.tpl', 49, false),array('modifier', 'nl2br', 'CRM/Contact/Page/Inline/Email.tpl', 57, false),)), $this); ?>
...
<?php endif; ?>
  ...
  <?php endif; ?>
  <?php $_from = $this->_tpl_vars['email']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['blockId'] => $this->_tpl_vars['item']):
?>
    <?php if ($this->_tpl_vars['item']['email']): ?>
    <div class="crm-summary-row <?php if (! empty ( $this->_tpl_vars['item']['is_primary'] )): ?>primary<?php endif; ?>">
      <div class="crm-label">
...
" title="<?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['item']['email'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Send email to %1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>">
          ...
          <?php else: ?>
            <a href="<?php echo smarty_function_crmURL(array('p' => "civicrm/activity/email/add",'q' => "action=add&reset=1&email_id=".($this->_tpl_vars['item']['id'])), $this);?>
" class="crm-popup" title="<?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['item']['email'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Send email to %1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>">
        ...
        <?php endif; ?>
        <?php echo smarty_function_crmAPI(array('var' => 'civi_mail','entity' => 'Extension','action' => 'get','full_name' => 'civi_mail','is_active' => 1), $this);?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php elseif ($this->_tpl_vars['item']['on_hold']): ?>&nbsp;<?php if ($this->_tpl_vars['civi_mail']['count']): ?><a href="<?php echo smarty_function_crmURL(array('p' => "civicrm/contact/view/bounces",'q' => "email_id=".($this->_tpl_vars['item']['id'])), $this);?>
" class="crm-popup" title="<?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['item']['email'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Email Bounce History<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><?php endif; ?>(<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>On Hold<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>)&nbsp;<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item']['hold_date'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 10, '') : smarty_modifier_truncate($_tmp, 10, '')))) ? $this->_run_mod_handler('crmDate', true, $_tmp) : smarty_modifier_crmDate($_tmp)); ?>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php if ($this->_tpl_vars['civi_mail']['count']): ?>&nbsp;<i class="crm-i fa-list-alt" aria-hidden="true"></i></a><?php endif; ?><?php endif; ?><?php if ($this->_tpl_vars['item']['is_bulkmail']): ?>&nbsp;(<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Bulk<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>)<?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['item']['signature_text'] ) || ! empty ( $this->_tpl_vars['item']['signature_html'] )): ?>
