...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/Inline/ContactName.tpl', 1, false),array('block', 'crmRegion', 'CRM/Contact/Page/Inline/ContactName.tpl', 11, false),array('block', 'ts', 'CRM/Contact/Page/Inline/ContactName.tpl', 12, false),)), $this); ?>
...
", "class_name": "CRM_Contact_Form_Inline_ContactName"}' data-dependent-fields='["#crm-communication-pref-content"]'<?php endif; ?>>
  <?php $this->_tag_stack[] = array('crmRegion', array('name' => "contact-page-contactname")); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
