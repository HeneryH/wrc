...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Profile/Page/Dynamic.tpl', 1, false),array('block', 'crmRegion', 'CRM/Profile/Page/Dynamic.tpl', 17, false),array('modifier', 'truncate', 'CRM/Profile/Page/Dynamic.tpl', 15, false),)), $this); ?>
...
">
            ...
            <?php $_from = $this->_tpl_vars['profileFields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
