...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Edit/Individual.tpl', 1, false),array('block', 'crmRegion', 'CRM/Contact/Form/Edit/Individual.tpl', 12, false),array('function', 'help', 'CRM/Contact/Form/Edit/Individual.tpl', 54, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><table class="form-layout-compressed">
  <?php $this->_tag_stack[] = array('crmRegion', array('name' => "contact-form-edit-individual")); $_block_repeat=true;smarty_block_crmRegion($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <tr>
      <?php if (! empty ( $this->_tpl_vars['form']['prefix_id'] )): ?>
      <td>
...
<br/>
      ...
      <?php endif; ?>
      <?php if (! empty ( $this->_tpl_vars['form']['first_name'] )): ?>
      <td>
...
<br />
      ...
      <?php endif; ?>
      <?php if (! empty ( $this->_tpl_vars['form']['middle_name'] )): ?>
      <td>
...
<br />
      ...
      <?php endif; ?>
      <?php if (! empty ( $this->_tpl_vars['form']['last_name'] )): ?>
      <td>
...
<br />
      ...
      <?php endif; ?>
      <?php if (! empty ( $this->_tpl_vars['form']['suffix_id'] )): ?>
      <td>
...
<br />
      ...
      <?php if (! empty ( $this->_tpl_vars['form']['contact_sub_type'] )): ?>
      <td>
