...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contribute/Form/Contribution/OnBehalfOf.tpl', 1, false),array('block', 'crmRegion', 'CRM/Contribute/Form/Contribution/OnBehalfOf.tpl', 27, false),array('modifier', 'count', 'CRM/Contribute/Form/Contribution/OnBehalfOf.tpl', 28, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (! empty ( $this->_tpl_vars['form']['is_for_organization'] )): ?>
...
<div class="crm-public-form-item" id="on-behalf-block">
  ...
  <?php if ($this->_tpl_vars['onBehalfOfFields'] && count($this->_tpl_vars['onBehalfOfFields'])): ?>
    <fieldset>
      <legend><?php echo $this->_tpl_vars['fieldSetTitle']; ?>
</legend>
      <?php if (! empty ( $this->_tpl_vars['form']['org_option'] )): ?>
