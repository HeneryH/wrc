    ...
    <?php else: ?>
      <div class="crm-summary-row <?php if ($this->_tpl_vars['add']['is_primary'] == 1): ?> primary<?php endif; ?>">
        <div class="crm-label">
          ...
          <?php $this->assign('mapLocationTypeID', $this->_tpl_vars['add']['location_type_id']); ?>
          <br /><a href="<?php echo smarty_function_crmURL(array('p' => 'civicrm/contact/map','q' => "reset=1&cid=".($this->_tpl_vars['contactId'])."&lid=".($this->_tpl_vars['mapLocationTypeID'])), $this);?>
" title="<?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['add']['location_type'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Map %1 Address<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><i class="crm-i fa-map-marker" aria-hidden="true"></i> <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Map<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a>
        ...
        <div class="crm-content">
          ...
          <?php endif; ?>
          <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['add']['display'])) ? $this->_run_mod_handler('purify', true, $_tmp) : smarty_modifier_purify($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

        </div>
      </div>

    <!-- add custom data -->
    <?php $_from = $this->_tpl_vars['add']['custom']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cgId'] => $this->_tpl_vars['customGroup']):
?>       <?php $this->assign('isAddressCustomPresent', 1); ?>
      <?php $_from = $this->_tpl_vars['customGroup']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
-accordion
        ...
        <div class="crm-summary-block">
          <?php $_from = $this->_tpl_vars['customValue']['fields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
