<?php /* Smarty version 2.6.32, created on 2023-08-23 10:09:36
         compiled from CRM/Contact/Form/Search/ResultTasks.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Search/ResultTasks.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/Search/ResultTasks.tpl', 20, false),array('function', 'crmURL', 'CRM/Contact/Form/Search/ResultTasks.tpl', 12, false),array('function', 'help', 'CRM/Contact/Form/Search/ResultTasks.tpl', 22, false),array('modifier', 'count', 'CRM/Contact/Form/Search/ResultTasks.tpl', 50, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['context'] == 'smog'): ?><?php echo smarty_function_crmURL(array('p' => 'civicrm/group/search/advanced','q' => "gid=".($this->_tpl_vars['group']['id'])."&reset=1&force=1"), $this);?>

<?php elseif ($this->_tpl_vars['context'] == 'amtg'): ?><?php echo smarty_function_crmURL(array('p' => 'civicrm/contact/search/advanced','q' => "context=amtg&amtgID=".($this->_tpl_vars['group']['id'])."&reset=1&force=1"), $this);?>

<?php else: ?><?php echo smarty_function_crmURL(array('p' => 'civicrm/contact/search/advanced','q' => "reset=1"), $this);?>
...
"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Advanced Search<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a><br />
        <?php if ($this->_tpl_vars['context'] == 'smog'): ?>
            <?php echo smarty_function_help(array('id' => "id-smog-criteria",'group_title' => $this->_tpl_vars['group']['title']), $this);?>
...
"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Advanced Search<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a><br />
  ...
  <tr>
    <td style="width: 30%;">
        <?php if (! empty ( $this->_tpl_vars['savedSearch']['name'] )): ?><?php echo $this->_tpl_vars['savedSearch']['name']; ?>
