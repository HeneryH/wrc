...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (array_key_exists ( 'geo_code_1' , $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']] ) && array_key_exists ( 'geo_code_2' , $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']] )): ?>
  <tr>
    <td colspan="2">
...
<br />
  ...
  <?php if (array_key_exists ( 'manual_geo_code' , $this->_tpl_vars['form']['address'][$this->_tpl_vars['blockId']] )): ?>
    <tr>
      <td colspan="2">
