...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/UF/Form/Fields.tpl', 1, false),array('modifier', 'substr', 'CRM/UF/Form/Fields.tpl', 85, false),array('modifier', 'crmDate', 'CRM/UF/Form/Fields.tpl', 96, false),array('modifier', 'replace', 'CRM/UF/Form/Fields.tpl', 112, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $_from = $this->_tpl_vars['fields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
?>
  ...
  <?php if ($this->_tpl_vars['prefix']): ?>
    ...
    <?php $this->assign('rowIdentifier', $this->_tpl_vars['form'][$this->_tpl_vars['prefix']][$this->_tpl_vars['profileFieldName']]['id']); ?>
  <?php else: ?>
    <?php $this->assign('formElement', $this->_tpl_vars['form'][$this->_tpl_vars['profileFieldName']]); ?>
    <?php $this->assign('rowIdentifier', $this->_tpl_vars['field']['name']); ?>
  <?php endif; ?>
...
"><legend><?php echo $this->_tpl_vars['field']['groupDisplayTitle']; ?>
</legend>
    <?php endif; ?>

    <?php if (( $this->_tpl_vars['form']['formName'] == 'Confirm' || $this->_tpl_vars['form']['formName'] == 'ThankYou' ) && $this->_tpl_vars['prefix'] != 'honor'): ?>
      <div class="header-dark"><?php echo $this->_tpl_vars['field']['groupDisplayTitle']; ?>
 </div>
    <?php endif; ?>
...
-section helprow-pre" id="helprow-<?php echo $this->_tpl_vars['rowIdentifier']; ?>
">
...
-section form-item" id="editrow-<?php echo $this->_tpl_vars['rowIdentifier']; ?>
">
        ...
        <div class="content 3">
          ...
          <?php echo '<table class="form-layout-compressed"><tr>'; ?><?php echo ''; ?><?php $_from = $this->_tpl_vars['formElement']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['outer'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['outer']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
        $this->_foreach['outer']['iteration']++;
?><?php echo ''; ?><?php echo ''; ?><?php if (is_array ( $this->_tpl_vars['item'] ) && array_key_exists ( 'html' , $this->_tpl_vars['item'] )): ?><?php echo '<td class="labels font-light">'; ?><?php echo $this->_tpl_vars['formElement'][$this->_tpl_vars['key']]['html']; ?><?php echo '</td>'; ?><?php if ($this->_tpl_vars['count'] == $this->_tpl_vars['field']['options_per_line']): ?><?php echo '</tr><tr>'; ?><?php $this->assign('count', '1'); ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php $this->assign('count', ($this->_tpl_vars['count']+1)); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo '</tr></table>'; ?>
...
"
          ...
          <?php elseif (( $this->_tpl_vars['profileFieldName'] == 'image_URL' )): ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php endif; ?>
      ...
      <div class="crm-section helprow-<?php echo $this->_tpl_vars['profileFieldName']; ?>
-section helprow-post" id="helprow-<?php echo $this->_tpl_vars['rowIdentifier']; ?>
">
