<?php /* Smarty version 2.6.32, created on 2023-08-23 13:41:13
         compiled from CRM/common/fatal.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/fatal.tpl', 1, false),array('block', 'ts', 'CRM/common/fatal.tpl', 36, false),array('modifier', 'escape', 'CRM/common/fatal.tpl', 16, false),array('modifier', 'truncate', 'CRM/common/fatal.tpl', 26, false),array('modifier', 'purify', 'CRM/common/fatal.tpl', 49, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if ($this->_tpl_vars['config']->userFramework != 'WordPress'): ?>
...
<div class="messages status no-popup">  <i class="crm-i fa-exclamation-triangle crm-i-red" aria-hidden="true"></i>
 <span class="status-fatal"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Sorry, due to an error, we are unable to fulfill your request at the moment. You may want to contact your administrator or service provider with more details about what action you were performing when this occurred.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
    ...
    <?php if (! empty ( $this->_tpl_vars['error']['message'] ) && $this->_tpl_vars['message'] != $this->_tpl_vars['error']['message']): ?>
        <hr style="solid 1px" />
    ...
    <?php endif; ?>
    <?php if (( ! empty ( $this->_tpl_vars['code'] ) || ! empty ( $this->_tpl_vars['mysql_code'] ) || ! empty ( $this->_tpl_vars['errorDetails'] ) ) && $this->_tpl_vars['config']->debug): ?>
        <div class="crm-accordion-wrapper collapsed crm-fatal-error-details-block">
         ...
         <div class="crm-accordion-body">
            <?php if (! empty ( $this->_tpl_vars['code'] )): ?>
            ...
            <?php endif; ?>
            <?php if (! empty ( $this->_tpl_vars['mysql_code'] )): ?>
            ...
            <?php endif; ?>
            <?php if (! empty ( $this->_tpl_vars['errorDetails'] )): ?>
...
<?php if ($this->_tpl_vars['config']->userFramework != 'WordPress'): ?>
</body>
</html>
<?php endif; ?>
