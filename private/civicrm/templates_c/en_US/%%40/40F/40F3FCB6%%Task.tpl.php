<?php /* Smarty version 2.6.32, created on 2023-08-23 10:10:29
         compiled from CRM/Contact/Form/Task.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Task.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/Task.tpl', 10, false),array('function', 'cycle', 'CRM/Contact/Form/Task.tpl', 24, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['isSelectedContacts']): ?>
<div id="popupContainer">
  <div class="crm-block crm-form-block crm-search-form-block">
    <table id="selectedRecords-" class="display crm-copy-fields crm-sortable">
      ...
      <tbody>
        <?php $_from = $this->_tpl_vars['value']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
