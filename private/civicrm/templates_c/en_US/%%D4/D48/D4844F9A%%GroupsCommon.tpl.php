<?php /* Smarty version 2.6.32, created on 2023-08-23 09:57:09
         compiled from CRM/Group/Form/GroupsCommon.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Group/Form/GroupsCommon.tpl', 1, false),array('block', 'ts', 'CRM/Group/Form/GroupsCommon.tpl', 12, false),array('modifier', 'count', 'CRM/Group/Form/GroupsCommon.tpl', 11, false),array('modifier', 'cat', 'CRM/Group/Form/GroupsCommon.tpl', 19, false),array('modifier', 'crmAddClass', 'CRM/Group/Form/GroupsCommon.tpl', 30, false),array('function', 'help', 'CRM/Group/Form/GroupsCommon.tpl', 12, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (count($this->_tpl_vars['parent_groups']) > 0 || ! empty ( $this->_tpl_vars['form']['parents']['html'] )): ?>
  ...
  <?php if (count($this->_tpl_vars['parent_groups']) > 0): ?>
    <table class="form-layout-compressed">
      ...
      <?php $_from = $this->_tpl_vars['parent_groups']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<?php endif; ?>
<?php if (array_key_exists ( 'organization_id' , $this->_tpl_vars['form'] )): ?>
