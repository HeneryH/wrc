...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (! empty ( $this->_tpl_vars['form']['javascript'] )): ?>
  <?php echo $this->_tpl_vars['form']['javascript']; ?>

<?php endif; ?>

<?php if (! empty ( $this->_tpl_vars['form']['hidden'] )): ?>
  <div><?php echo $this->_tpl_vars['form']['hidden']; ?>
</div>
<?php endif; ?>

<?php if (( $this->_tpl_vars['snippet'] !== 'json' ) && ! $this->_tpl_vars['suppressForm'] && $this->_tpl_vars['form']['errors']): ?>
   <div class="messages crm-error">
     ...
     <ul id="errorList">
     <?php $_from = $this->_tpl_vars['form']['errors']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<?php if ($this->_tpl_vars['beginHookFormElements']): ?>
  ...
  <?php $_from = $this->_tpl_vars['beginHookFormElements']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
