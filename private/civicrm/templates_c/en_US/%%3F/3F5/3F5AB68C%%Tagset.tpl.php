...
<?php endif; ?>
<?php if (! empty ( $this->_tpl_vars['tableLayout'] )): ?>
  <td colspan="2" class="crm-content-block">
    <table>
<?php endif; ?>
   <?php if (! empty ( $this->_tpl_vars['tagsetInfo'] )): ?>
    <?php $_from = $this->_tpl_vars['tagsetInfo'][$this->_tpl_vars['tagsetType']]; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<?php if (! empty ( $this->_tpl_vars['tagsetInfo'] ) && empty ( $this->_tpl_vars['skipEntityAction'] ) && empty ( $this->_tpl_vars['form']['frozen'] )): ?>
