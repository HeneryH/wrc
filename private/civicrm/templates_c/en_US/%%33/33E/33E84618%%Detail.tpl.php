<?php /* Smarty version 2.6.32, created on 2023-08-23 09:42:45
         compiled from CRM/Report/Form/Contact/Detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Report/Form/Contact/Detail.tpl', 1, false),array('modifier', 'count', 'CRM/Report/Form/Contact/Detail.tpl', 29, false),array('modifier', 'cat', 'CRM/Report/Form/Contact/Detail.tpl', 80, false),array('modifier', 'escape', 'CRM/Report/Form/Contact/Detail.tpl', 83, false),array('modifier', 'crmDate', 'CRM/Report/Form/Contact/Detail.tpl', 89, false),array('modifier', 'truncate', 'CRM/Report/Form/Contact/Detail.tpl', 93, false),array('modifier', 'crmMoney', 'CRM/Report/Form/Contact/Detail.tpl', 96, false),array('modifier', 'replace', 'CRM/Report/Form/Contact/Detail.tpl', 113, false),array('modifier', 'crmUpper', 'CRM/Report/Form/Contact/Detail.tpl', 113, false),array('function', 'counter', 'CRM/Report/Form/Contact/Detail.tpl', 33, false),array('function', 'eval', 'CRM/Report/Form/Contact/Detail.tpl', 59, false),array('function', 'cycle', 'CRM/Report/Form/Contact/Detail.tpl', 123, false),)), $this); ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/Report/Form/Statistics.tpl", 'smarty_include_vars' => array('top' => true,'bottom' => false)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
"><?php endif; ?>
                        ...
                        <?php if ($this->_tpl_vars['columnHeadersComponent']): ?>
                            ...
                            <?php $_from = $this->_tpl_vars['columnHeadersComponent']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
?>
                                <?php if ($this->_tpl_vars['componentRows'][$this->_tpl_vars['componentContactId']][$this->_tpl_vars['component']]): ?>
                                    <h3><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['component'])) ? $this->_run_mod_handler('replace', true, $_tmp, '_civireport', '') : smarty_modifier_replace($_tmp, '_civireport', '')))) ? $this->_run_mod_handler('crmUpper', true, $_tmp) : smarty_modifier_crmUpper($_tmp)); ?>
</h3>
                          <table class="report-layout crm-report_<?php echo $this->_tpl_vars['component']; ?>
">
                                                          <tr>
                                <?php $_from = $this->_tpl_vars['pheader']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
?>
                              ...
                              <?php $_from = $this->_tpl_vars['componentRows'][$this->_tpl_vars['componentContactId']][$this->_tpl_vars['component']]; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
                                <?php $_from = $this->_tpl_vars['columnHeadersComponent'][$this->_tpl_vars['component']]; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['field'] => $this->_tpl_vars['header']):
?>
                              <?php $this->assign('fieldLink', ((is_array($_tmp=$this->_tpl_vars['field'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_link') : smarty_modifier_cat($_tmp, '_link'))); ?>
                                                <?php $this->assign('fieldHover', ((is_array($_tmp=$this->_tpl_vars['field'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_hover') : smarty_modifier_cat($_tmp, '_hover'))); ?>
...
?>
        ...
        <?php if (! $this->_tpl_vars['section']): ?>
                        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/Report/Form/Statistics.tpl", 'smarty_include_vars' => array('top' => false,'bottom' => true)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        <?php endif; ?>
