...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/paymentBlock.tpl', 1, false),array('modifier', 'json_encode', 'CRM/common/paymentBlock.tpl', 55, false),array('function', 'crmURL', 'CRM/common/paymentBlock.tpl', 107, false),)), $this); ?>
...
'; ?>
<?php if (! $this->_tpl_vars['isBackOffice']): ?><?php echo '
  /**
  ...
  function skipPaymentMethod() {
    var isHide = false;
    var isMultiple = '; ?>
<?php echo json_encode($this->_tpl_vars['event']['is_multiple_registrations']); ?>
<?php echo ';
...
<?php endif; ?><?php echo '
  ...
  CRM.$(function($) {
    function buildPaymentBlock(type) {
      ...
      <?php if (! $this->_tpl_vars['isBackOffice'] && $this->_tpl_vars['contributionPageID']): ?>
...
&<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('contributionPageID', ob_get_contents());ob_end_clean(); ?>
      <?php else: ?>
        <?php ob_start(); ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('contributionPageID', ob_get_contents());ob_end_clean(); ?>
      <?php endif; ?>
      <?php if (! $this->_tpl_vars['isBackOffice'] && $this->_tpl_vars['custom_pre_id']): ?>
...
&<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('urlPathVar', ob_get_contents());ob_end_clean(); ?>
      ...
      <?php if (! $this->_tpl_vars['isBackOffice'] && $this->_tpl_vars['billing_profile_id']): ?>
...
';
      ...
      var dataUrl = "<?php echo smarty_function_crmURL(array('p' => 'civicrm/payment/form','h' => 0,'q' => "formName=".($this->_tpl_vars['form']['formName']).($this->_tpl_vars['urlPathVar']).($this->_tpl_vars['isBackOfficePathVar']).($this->_tpl_vars['profilePathVar']).($this->_tpl_vars['contributionPageID']).($this->_tpl_vars['preProfileID'])."processor_id="), $this);?>
" + type;
      <?php echo '
