...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Report/Form/Criteria.tpl', 1, false),array('block', 'crmRegion', 'CRM/Report/Form/Criteria.tpl', 15, false),array('modifier', 'cat', 'CRM/Report/Form/Criteria.tpl', 13, false),)), $this); ?>
...
?>
    ...
    <?php if (! ( ! empty ( $this->_tpl_vars['field']['operatorType'] ) && $this->_tpl_vars['field']['operatorType'] & 4 ) && empty ( $this->_tpl_vars['field']['no_display'] ) && ! empty ( $this->_tpl_vars['form'][$this->_tpl_vars['fieldOp']]['html'] )): ?>
...
<?php echo '
  ...
  CRM.$(function($) {
    ...
    '; ?>
<?php if (! empty ( $this->_tpl_vars['displayToggleGroupByFields'] )): ?><?php echo '
