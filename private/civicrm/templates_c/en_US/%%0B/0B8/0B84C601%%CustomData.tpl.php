...
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $_from = $this->_tpl_vars['groupTree']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['custom_sets'] = array('total' => count($_from), 'iteration' => 0);
...
?>
    ...
    <?php else: ?>
            <?php $this->assign('isSingleRecordEdit', false); ?>
    <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php else: ?>
     <div class="custom-group custom-group-<?php echo $this->_tpl_vars['cd_edit']['name']; ?>
 crm-accordion-wrapper crm-custom-accordion <?php if ($this->_tpl_vars['cd_edit']['collapse_display'] && empty ( $this->_tpl_vars['skipTitle'] )): ?>collapsed<?php endif; ?>">
      <?php if (empty ( $this->_tpl_vars['skipTitle'] )): ?>
