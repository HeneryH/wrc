<?php /* Smarty version 2.6.32, created on 2023-08-23 09:21:18
...
<?php $_from = $this->_tpl_vars['adminPanel']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
  ...
  <div class="admin-section-items">
    <?php $_from = $this->_tpl_vars['group']['fields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
