...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Core/BillingBlock.tpl', 1, false),array('block', 'crmRegion', 'CRM/Core/BillingBlock.tpl', 10, false),array('block', 'ts', 'CRM/Core/BillingBlock.tpl', 24, false),array('modifier', 'crmAddClass', 'CRM/Core/BillingBlock.tpl', 68, false),array('modifier', 'json_encode', 'CRM/Core/BillingBlock.tpl', 83, false),)), $this); ?>
...
<div id="payment_information">
  <?php if ($this->_tpl_vars['paymentFields']): ?>
...
_info-section">
        <?php $_from = $this->_tpl_vars['paymentFields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
-section">
            ...
            <div class="content">
                <?php echo $this->_tpl_vars['form'][$this->_tpl_vars['paymentField']]['html']; ?>

              <?php if ($this->_tpl_vars['paymentFieldsMetadata'][$this->_tpl_vars['name']]['description']): ?>
                <div class="description"><?php echo $this->_tpl_vars['paymentFieldsMetadata'][$this->_tpl_vars['name']]['description']; ?>
</div>
              <?php elseif ($this->_tpl_vars['paymentField'] == 'cvv2'): ?>                <span class="cvv2-icon" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Usually the last 3-4 digits in the signature area on the back of the card.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"> </span>
              <?php endif; ?>
    ...
    <?php if (! $this->_tpl_vars['isBackOffice'] && $this->_tpl_vars['paymentAgreementTitle']): ?>
      <div id="payment_notice">
        <fieldset class="crm-public-form-item crm-group payment_notice-group">
          <legend><?php echo $this->_tpl_vars['paymentAgreementTitle']; ?>
</legend>
          <?php echo $this->_tpl_vars['paymentAgreementText']; ?>

        </fieldset>
      </div>
    <?php endif; ?>
  <?php endif; ?>
  <?php if ($this->_tpl_vars['billingDetailsFields'] && $this->_tpl_vars['paymentProcessor']['payment_processor_type'] != 'PayPal_Express'): ?>
    ...
    <fieldset class="billing_name_address-group">
      ...
      <div class="crm-section billing_name_address-section">
        <?php $_from = $this->_tpl_vars['billingDetailsFields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
