...
<?php endif; ?>
    <table class="form-layout-compressed<?php if ($this->_tpl_vars['context'] == 'profile'): ?> crm-profile-tagsandgroups<?php endif; ?>">
      <tr>
        <td>
          <?php if ($this->_tpl_vars['form']['tag']): ?>
            <div class="crm-section tag-section">
              <?php if (! empty ( $this->_tpl_vars['title'] )): ?><?php echo $this->_tpl_vars['form']['tag']['label']; ?>
<br><?php endif; ?>
...
<br><?php endif; ?>
            ...
            <?php else: ?>
              <?php $_from = $this->_tpl_vars['tagGroup']['group']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
