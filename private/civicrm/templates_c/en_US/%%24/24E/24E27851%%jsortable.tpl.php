...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/jsortable.tpl', 1, false),array('block', 'ts', 'CRM/common/jsortable.tpl', 100, false),)), $this); ?>
...
<script type="text/javascript">
  CRM.$(function($) {
    ...
    var useAjax = '; ?>
<?php echo $this->_tpl_vars['useAjax']; ?>
<?php echo ',
      sourceUrl = \'\',
      useClass  = \'display\',
      tcount = 1,
    ...
    if ( useAjax ) {
      '; ?>
<?php if ($this->_tpl_vars['sourceUrl']): ?>sourceUrl = "<?php echo $this->_tpl_vars['sourceUrl']; ?>
";<?php endif; ?><?php echo '
