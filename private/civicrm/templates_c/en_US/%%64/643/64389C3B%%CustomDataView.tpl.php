...
<?php $_from = $this->_tpl_vars['viewCustomData']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
?>
  ...
  <?php if (( $this->_tpl_vars['count'] == $this->_tpl_vars['side'] ) || $this->_tpl_vars['skipTitle']): ?>
    <?php $_from = $this->_tpl_vars['customValues']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cvID'] => $this->_tpl_vars['cd_edit']):
?>
      <div class="customFieldGroup crm-collapsible<?php if (! empty ( $this->_tpl_vars['cd_edit']['collapse_display'] )): ?> collapsed<?php endif; ?> ui-corner-all <?php echo $this->_tpl_vars['cd_edit']['name']; ?>
