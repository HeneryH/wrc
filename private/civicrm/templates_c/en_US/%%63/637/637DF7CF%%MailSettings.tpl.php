<?php /* Smarty version 2.6.32, created on 2023-08-23 10:24:38
         compiled from CRM/Admin/Form/MailSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Admin/Form/MailSettings.tpl', 1, false),array('block', 'icon', 'CRM/Admin/Form/MailSettings.tpl', 14, false),array('block', 'ts', 'CRM/Admin/Form/MailSettings.tpl', 15, false),array('function', 'help', 'CRM/Admin/Form/MailSettings.tpl', 54, false),)), $this); ?>
 ...
 ?></div>
  <?php else: ?>
    <table class="form-layout-compressed">
      ...
      <tr class="crm-mail-settings-form-block-is_non_case_email_skipped"><td class="label">&nbsp;</td><td><?php echo $this->_tpl_vars['form']['is_non_case_email_skipped']['html']; ?>
<?php echo $this->_tpl_vars['form']['is_non_case_email_skipped']['label']; ?>
 <?php echo smarty_function_help(array('id' => 'is_non_case_email_skipped'), $this);?>
</td></tr>

      <tr class="crm-mail-settings-form-block-is_contact_creation_disabled_if_no_match"><td class="label">&nbsp;</td><td><?php echo $this->_tpl_vars['form']['is_contact_creation_disabled_if_no_match']['html']; ?>
<?php echo $this->_tpl_vars['form']['is_contact_creation_disabled_if_no_match']['label']; ?>
 <?php echo smarty_function_help(array('id' => 'is_contact_creation_disabled_if_no_match'), $this);?>
</td></tr>

      <tr class="crm-mail-settings-form-block-activity_status"><td class="label">&nbsp;</td><td><?php echo $this->_tpl_vars['form']['activity_status']['label']; ?>
<div><?php echo $this->_tpl_vars['form']['activity_status']['html']; ?>
</div></td></tr>
    </table>
