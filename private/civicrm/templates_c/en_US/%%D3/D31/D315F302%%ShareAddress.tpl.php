...
" class="form-layout-compressed">
      ...
      <div class="shared-address-list">
        <?php if (! empty ( $this->_tpl_vars['sharedAddresses'][$this->_tpl_vars['blockId']]['shared_address_display'] )): ?>
          <?php $_from = $this->_tpl_vars['sharedAddresses'][$this->_tpl_vars['blockId']]['shared_address_display']['options']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
