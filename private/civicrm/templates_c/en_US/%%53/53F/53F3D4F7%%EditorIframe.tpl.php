<?php /* Smarty version 2.6.32, created on 2023-08-23 09:30:52
...
">
  ...
  <?php $_from = $this->_tpl_vars['scriptUrls']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
  ...
  <?php $_from = $this->_tpl_vars['styleUrls']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
