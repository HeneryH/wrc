<?php /* Smarty version 2.6.32, created on 2023-08-23 13:41:11
         compiled from /var/www/varbase/docroot/sites/default/files/civicrm/ext/stripe-6.9.2/templates/CRM/Core/Payment/Stripe/Card.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', '/var/www/varbase/docroot/sites/default/files/civicrm/ext/stripe-6.9.2/templates/CRM/Core/Payment/Stripe/Card.tpl', 1, false),)), $this); ?>
  ...
  CRM.$(function($) {
    $(document).ready(function() {
      if (typeof CRM.vars.stripe === \'undefined\') {
        var stripe = {'; ?>
<?php $_from = $this->_tpl_vars['stripeJSVars']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
