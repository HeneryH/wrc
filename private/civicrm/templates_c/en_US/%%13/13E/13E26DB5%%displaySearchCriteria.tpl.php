...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/displaySearchCriteria.tpl', 1, false),array('block', 'ts', 'CRM/common/displaySearchCriteria.tpl', 20, false),array('modifier', 'escape', 'CRM/common/displaySearchCriteria.tpl', 18, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $_from = $this->_tpl_vars['qill']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['sets'] = array('total' => count($_from), 'iteration' => 0);
...
?>
    <?php if ($this->_foreach['sets']['total'] > 2): ?>
                <?php if ($this->_tpl_vars['orClauses']): ?>
        <ul>
        <li>
        <?php $_from = $this->_tpl_vars['orClauses']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['criteria'] = array('total' => count($_from), 'iteration' => 0);
...
?>
            ...
            <?php if (! ($this->_foreach['criteria']['iteration'] == $this->_foreach['criteria']['total'])): ?>
                <?php if (! empty ( $this->_tpl_vars['operator'] )): ?>
