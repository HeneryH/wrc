  ...
  <div class="crm-block crm-content-block crm-contact-page crm-inline-edit-container">
    <div id="mainTabContainer">
      <ul class="crm-contact-tabs-list">
        <?php $_from = $this->_tpl_vars['allTabs']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['tabValue']):
?>
          <li id="tab_<?php echo $this->_tpl_vars['tabValue']['id']; ?>
" class="crm-tab-button ui-corner-all<?php if (is_numeric ( $this->_tpl_vars['tabValue']['count'] )): ?> crm-count-<?php echo $this->_tpl_vars['tabValue']['count']; ?>
<?php endif; ?><?php if ($this->_tpl_vars['tabValue']['class']): ?> <?php echo $this->_tpl_vars['tabValue']['class']; ?>
<?php endif; ?>">
            <a href="<?php if ($this->_tpl_vars['tabValue']['template']): ?>#contact-<?php echo $this->_tpl_vars['tabValue']['id']; ?>
...
">
              <i class="<?php if (! empty ( $this->_tpl_vars['tabValue']['icon'] )): ?><?php echo $this->_tpl_vars['tabValue']['icon']; ?>
<?php else: ?>crm-i fa-puzzle-piece<?php endif; ?>" aria-hidden="true"></i>
              <span><?php echo $this->_tpl_vars['tabValue']['title']; ?>
</span>
              <?php if (empty ( $this->_tpl_vars['tabValue']['hideCount'] )): ?><em><?php if (is_numeric ( $this->_tpl_vars['tabValue']['count'] )): ?><?php echo $this->_tpl_vars['tabValue']['count']; ?>
