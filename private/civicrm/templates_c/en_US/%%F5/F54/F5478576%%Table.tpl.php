...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Report/Form/Layout/Table.tpl', 1, false),array('block', 'ts', 'CRM/Report/Form/Layout/Table.tpl', 11, false),array('modifier', 'escape', 'CRM/Report/Form/Layout/Table.tpl', 29, false),array('modifier', 'count', 'CRM/Report/Form/Layout/Table.tpl', 54, false),array('modifier', 'cat', 'CRM/Report/Form/Layout/Table.tpl', 97, false),array('modifier', 'crmDate', 'CRM/Report/Form/Layout/Table.tpl', 113, false),array('modifier', 'truncate', 'CRM/Report/Form/Layout/Table.tpl', 118, false),array('modifier', 'crmMoney', 'CRM/Report/Form/Layout/Table.tpl', 125, false),array('function', 'counter', 'CRM/Report/Form/Layout/Table.tpl', 59, false),array('function', 'eval', 'CRM/Report/Form/Layout/Table.tpl', 94, false),array('function', 'cycle', 'CRM/Report/Form/Layout/Table.tpl', 95, false),)), $this); ?>
...
><?php echo ((is_array($_tmp=$this->_tpl_vars['header']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</th>
...
><?php echo ((is_array($_tmp=$this->_tpl_vars['header']['title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <?php endif; ?>
            ...
            <?php $_from = $this->_tpl_vars['sections']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['sections'] = array('total' => count($_from), 'iteration' => 0);
...
?>
 ...
 <?php if ($this->_tpl_vars['row']['class']): ?><?php echo $this->_tpl_vars['row']['class']; ?>
<?php endif; ?> crm-report" id="crm-report_<?php echo $this->_tpl_vars['rowid']; ?>
">
                <?php $_from = $this->_tpl_vars['columnHeaders']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['field'] => $this->_tpl_vars['header']):
?>
...
<?php if ($this->_tpl_vars['header']['type'] == 1024 || $this->_tpl_vars['header']['type'] == 1 || $this->_tpl_vars['header']['type'] == 512): ?> report-contents-right<?php elseif ($this->_tpl_vars['row'][$this->_tpl_vars['field']] == 'Subtotal'): ?> report-label<?php endif; ?>">
                        <?php if (array_key_exists ( $this->_tpl_vars['fieldLink'] , $this->_tpl_vars['row'] ) && $this->_tpl_vars['row'][$this->_tpl_vars['fieldLink']]): ?>
...
"  <?php if (array_key_exists ( $this->_tpl_vars['fieldClass'] , $this->_tpl_vars['row'] )): ?> class="<?php echo $this->_tpl_vars['row'][$this->_tpl_vars['fieldClass']]; ?>
"<?php endif; ?>>
                        <?php endif; ?>

                        <?php if (is_array ( $this->_tpl_vars['row'][$this->_tpl_vars['field']] )): ?>
                            <?php $_from = $this->_tpl_vars['row'][$this->_tpl_vars['field']]; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['fieldid'] => $this->_tpl_vars['fieldrow']):
?>
                                <div class="crm-report-<?php echo $this->_tpl_vars['field']; ?>
-row-<?php echo $this->_tpl_vars['fieldid']; ?>
"><?php echo $this->_tpl_vars['fieldrow']; ?>
</div>
                            <?php endforeach; endif; unset($_from); ?>
                        <?php elseif ($this->_tpl_vars['row'][$this->_tpl_vars['field']] == 'Subtotal'): ?>
                        ...
                        <?php if (array_key_exists ( $this->_tpl_vars['fieldLink'] , $this->_tpl_vars['row'] ) && $this->_tpl_vars['row'][$this->_tpl_vars['fieldLink']]): ?></a><?php endif; ?>
                    </td>
                <?php endforeach; endif; unset($_from); ?>
            </tr>
        <?php endforeach; endif; unset($_from); ?>
...
?>
                    <td class="report-label">
                        <?php if ($this->_tpl_vars['header']['type'] == 1024): ?>
                            <?php if ($this->_tpl_vars['currencyColumn']): ?>
                                <?php echo ((is_array($_tmp=$this->_tpl_vars['grandStat'][$this->_tpl_vars['field']])) ? $this->_run_mod_handler('crmMoney', true, $_tmp, $this->_tpl_vars['row'][$this->_tpl_vars['currencyColumn']]) : smarty_modifier_crmMoney($_tmp, $this->_tpl_vars['row'][$this->_tpl_vars['currencyColumn']])); ?>
