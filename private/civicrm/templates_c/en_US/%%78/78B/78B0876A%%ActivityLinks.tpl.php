...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Activity/Form/ActivityLinks.tpl', 1, false),array('block', 'ts', 'CRM/Activity/Form/ActivityLinks.tpl', 14, false),array('modifier', 'escape', 'CRM/Activity/Form/ActivityLinks.tpl', 51, false),)), $this); ?>
...
<?php $_from = $this->_tpl_vars['activityTypes']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<?php if ($this->_tpl_vars['hookLinks']): ?>
   <?php $_from = $this->_tpl_vars['hookLinks']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
