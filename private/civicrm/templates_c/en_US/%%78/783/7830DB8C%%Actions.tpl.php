 ...
 ?>
          ...
          <div class="crm-contact_print-list">
            <ul class="contact-print">
              <?php $_from = $this->_tpl_vars['actionsMenuList']['otherActions']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
"<?php endif; ?>></i> <?php echo $this->_tpl_vars['row']['title']; ?>
          ...
          <ul class="contact-actions">
            <?php $_from = $this->_tpl_vars['actionsMenuList']['moreActions']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['row']):
?>
            <?php if (! empty ( $this->_tpl_vars['row']['href'] ) || ! empty ( $this->_tpl_vars['row']['tab'] )): ?>
