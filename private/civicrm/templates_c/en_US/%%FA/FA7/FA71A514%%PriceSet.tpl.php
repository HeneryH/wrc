...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Price/Form/PriceSet.tpl', 1, false),array('block', 'crmRegion', 'CRM/Price/Form/PriceSet.tpl', 10, false),array('block', 'icon', 'CRM/Price/Form/PriceSet.tpl', 22, false),array('block', 'ts', 'CRM/Price/Form/PriceSet.tpl', 22, false),array('function', 'crmURL', 'CRM/Price/Form/PriceSet.tpl', 21, false),array('modifier', 'cat', 'CRM/Price/Form/PriceSet.tpl', 34, false),array('modifier', 'count', 'CRM/Price/Form/PriceSet.tpl', 49, false),array('modifier', 'crmMoney', 'CRM/Price/Form/PriceSet.tpl', 73, false),)), $this); ?>
...
<div id="priceset" class="crm-section price_set-section">
    ...
    <?php if (call_user_func ( array ( 'CRM_Core_Permission' , 'check' ) , 'administer CiviCRM' )): ?>
      ...
      <?php if ($this->_tpl_vars['priceSet']['id'] && ! $this->_tpl_vars['priceSet']['is_quick_config']): ?>
        <div class='float-right'>
          <a class="crm-hover-button" target="_blank" href="<?php echo smarty_function_crmURL(array('p' => "civicrm/admin/price/field",'q' => "reset=1&action=browse&sid=".($this->_tpl_vars['priceSet']['id']),'fb' => 1), $this);?>
">
            <?php $this->_tag_stack[] = array('icon', array('icon' => "fa-wrench")); $_block_repeat=true;smarty_block_icon($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Edit Price Set<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_icon($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
          </a>
        </div>
      <?php endif; ?>
    <?php endif; ?>

    <?php $_from = $this->_tpl_vars['priceSet']['fields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['field_id'] => $this->_tpl_vars['element']):
?>
                <?php if ($this->_tpl_vars['element']['visibility'] == 'public' || ( $this->_tpl_vars['element']['visibility'] == 'admin' && $this->_tpl_vars['adminFld'] == true ) || $this->_tpl_vars['context'] == 'standalone' || $this->_tpl_vars['context'] == 'advanced' || $this->_tpl_vars['context'] == 'search' || $this->_tpl_vars['context'] == 'participant' || $this->_tpl_vars['context'] == 'dashboard'): ?>
...
-section crm-price-field-id-<?php echo $this->_tpl_vars['field_id']; ?>
">
...
-content">
                ...
                <?php $_from = $this->_tpl_vars['form'][$this->_tpl_vars['element_name']]; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['outer'] = array('total' => count($_from), 'iteration' => 0);
...
-content">
                  ...
                  <?php if ($this->_tpl_vars['element']['html_type'] == 'Text'): ?>
                    ...
                    <?php $_from = $this->_tpl_vars['element']['options']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
?>
                      <?php if (( $this->_tpl_vars['option']['tax_amount'] || $this->_tpl_vars['option']['tax_amount'] == '0' ) && $this->_tpl_vars['displayOpt'] && $this->_tpl_vars['invoicing']): ?>
                        ...
                        <?php elseif ($this->_tpl_vars['displayOpt'] == 'Inclusive'): ?>
                          ...
                          <span class='crm-price-amount-tax'> <?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['taxTerm'],'2' => ((is_array($_tmp=$this->_tpl_vars['option']['tax_amount'])) ? $this->_run_mod_handler('crmMoney', true, $_tmp, $this->_tpl_vars['currency']) : smarty_modifier_crmMoney($_tmp, $this->_tpl_vars['currency'])))); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>(includes %1 of %2)<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span>
                        <?php else: ?>
                          <?php echo ((is_array($_tmp=$this->_tpl_vars['option']['amount'])) ? $this->_run_mod_handler('crmMoney', true, $_tmp, $this->_tpl_vars['currency']) : smarty_modifier_crmMoney($_tmp, $this->_tpl_vars['currency'])); ?>

                          <span class='crm-price-amount-tax'> + <?php echo ((is_array($_tmp=$this->_tpl_vars['option']['tax_amount'])) ? $this->_run_mod_handler('crmMoney', true, $_tmp, $this->_tpl_vars['currency']) : smarty_modifier_crmMoney($_tmp, $this->_tpl_vars['currency'])); ?>
                  ...
                  <div id="allow_auto_renew">
                    <div class='crm-section auto-renew'>
                      ...
                      <div class='content' id="auto_renew_section">
                        <?php if ($this->_tpl_vars['form']['auto_renew']): ?>
