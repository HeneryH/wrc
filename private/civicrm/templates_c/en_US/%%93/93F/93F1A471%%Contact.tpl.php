 ...
 ?>
  ...
  <div class="crm-form-block crm-search-form-block">
    <?php if (call_user_func ( array ( 'CRM_Core_Permission' , 'check' ) , 'administer CiviCRM' )): ?>
      <a href='<?php echo smarty_function_crmURL(array('p' => "civicrm/admin/setting/preferences/display",'q' => "reset=1"), $this);?>
...
unset($_smarty_tpl_vars);
 ?>
          ...
          <table class="crm-section contact_information-section form-layout-compressed">
            <?php $_from = $this->_tpl_vars['blocks']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
unset($_smarty_tpl_vars);
 ?>
          ...
          <?php if (! empty ( $this->_tpl_vars['isDuplicate'] )): ?>
            &nbsp;&nbsp;
    ...
    <?php $_from = $this->_tpl_vars['editOptions']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
$this->_smarty_include(array('smarty_include_tpl_file' => "CRM/Contact/Form/Edit/CustomData.tpl", 'smarty_include_vars' => array('isSingleRecordEdit' => false)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></div>
      <?php else: ?>
...
"<?php echo ', subTypeValues, null, i, groupValue, true).one(\'crmLoad\', function() {
      ...
      <?php $_from = $this->_tpl_vars['customValueCount']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
