 ...
 */
class CachedCiviContainer_b189e831ffa956716b7cb8cc5d8877d4 extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'Civi\\Api4\\Service\\Spec\\Provider\\UserJobSpecProvider' => 'getUserJobSpecProviderService',
            ...
            'civi.firewall.declinedcard' => 'getCivi_Firewall_DeclinedcardService',
            'civi.firewall.formprotection' => 'getCivi_Firewall_FormprotectionService',
            'civi.firewall.fraudulentrequest' => 'getCivi_Firewall_FraudulentrequestService',
            'civi.firewall.invalidcsrfrequest' => 'getCivi_Firewall_InvalidcsrfrequestService',
            'civi.firewall.stripeauthorize' => 'getCivi_Firewall_StripeauthorizeService',
     ...
     */
    protected static function getParticipantAutocompleteProviderService($container)
    {
        return $container->services['Civi\\Api4\\Service\\Autocomplete\\ParticipantAutocompleteProvider'] = new \Civi\Api4\Service\Autocomplete\ParticipantAutocompleteProvider();
    }
     ...
     */
    protected static function getACLEntityRoleCreationSpecProviderService($container)
    {
        return $container->services['Civi\\Api4\\Service\\Spec\\Provider\\ACLEntityRoleCreationSpecProvider'] = new \Civi\Api4\Service\Spec\Provider\ACLEntityRoleCreationSpecProvider();
    }
     ...
     */
    protected static function getActionScheduleCreationSpecProviderService($container)
    {
        return $container->services['Civi\\Api4\\Service\\Spec\\Provider\\ActionScheduleCreationSpecProvider'] = new \Civi\Api4\Service\Spec\Provider\ActionScheduleCreationSpecProvider();
    }
     ...
     */
    protected static function getCampaignCreationSpecProviderService($container)
    {
        return $container->services['Civi\\Api4\\Service\\Spec\\Provider\\CampaignCreationSpecProvider'] = new \Civi\Api4\Service\Spec\Provider\CampaignCreationSpecProvider();
    }
     ...
     */
    protected static function getCustomGroupSpecProviderService($container)
    {
        return $container->services['Civi\\Api4\\Service\\Spec\\Provider\\CustomGroupSpecProvider'] = new \Civi\Api4\Service\Spec\Provider\CustomGroupSpecProvider();
    }
    ...
    /**
     * Gets the public 'Civi\Api4\Service\Spec\Provider\UserJobSpecProvider' shared service.
     *
     * @return \Civi\Api4\Service\Spec\Provider\UserJobSpecProvider
     */
    protected static function getUserJobSpecProviderService($container)
    {
        return $container->services['Civi\\Api4\\Service\\Spec\\Provider\\UserJobSpecProvider'] = new \Civi\Api4\Service\Spec\Provider\UserJobSpecProvider();
    }
    ...
    {
        return $container->services['cache.metadata'] = \CRM_Utils_Cache::create(['name' => 'metadata_5_65_beta1', 'type' => ['*memory*', 'SqlGroup', 'ArrayCache'], 'withArray' => 'fast']);
    }
    ...
    /**
     * Gets the public 'civi.firewall.declinedcard' shared service.
     *
     * @return \Civi\Firewall\Listener\DeclinedCard
     */
    protected static function getCivi_Firewall_DeclinedcardService($container)
    {
        return $container->services['civi.firewall.declinedcard'] = new \Civi\Firewall\Listener\DeclinedCard();
    }

    /**
     * Gets the public 'civi.firewall.formprotection' shared service.
     *
     * @return \Civi\Firewall\Listener\FormProtection
     */
    protected static function getCivi_Firewall_FormprotectionService($container)
    {
        return $container->services['civi.firewall.formprotection'] = new \Civi\Firewall\Listener\FormProtection();
    }

    /**
     * Gets the public 'civi.firewall.fraudulentrequest' shared service.
     *
     * @return \Civi\Firewall\Listener\FraudulentRequest
     */
    protected static function getCivi_Firewall_FraudulentrequestService($container)
    {
        return $container->services['civi.firewall.fraudulentrequest'] = new \Civi\Firewall\Listener\FraudulentRequest();
    }

    /**
     * Gets the public 'civi.firewall.invalidcsrfrequest' shared service.
     *
     * @return \Civi\Firewall\Listener\InvalidCSRFRequest
     */
    protected static function getCivi_Firewall_InvalidcsrfrequestService($container)
    {
        return $container->services['civi.firewall.invalidcsrfrequest'] = new \Civi\Firewall\Listener\InvalidCSRFRequest();
    }

    /**
     * Gets the public 'civi.firewall.stripeauthorize' shared service.
     *
     * @return \Civi\Firewall\Listener\StripeAuthorize
     */
    protected static function getCivi_Firewall_StripeauthorizeService($container)
    {
        return $container->services['civi.firewall.stripeauthorize'] = new \Civi\Firewall\Listener\StripeAuthorize();
    }
    ...
    protected static function getDispatcherService($container)
    {
        ...
        $instance->addListener('civi.dao.preInsert', 'civirules_trigger_preinsert');
        $instance->addListener('civi.dao.postInsert', 'civirules_trigger_postinsert');
        $instance->addListener('civi.dao.preUpdate', 'civirules_trigger_preupdate');
        $instance->addListener('civi.dao.postUpdate', 'civirules_trigger_postupdate');
        $instance->addListener('civi.dao.preDelete', 'civirules_trigger_predelete');
        $instance->addListener('civi.dao.postDelete', 'civirules_trigger_postdelete');
        $instance->addListenerService('civi.flexmailer.checkSendable', ['mosaico_required_tokens', 'onCheckSendable'], 0);
        $instance->addListenerService('civi.flexmailer.compose', ['mosaico_flexmail_composer', 'onCompose'], 0);
        $instance->addListenerService('civi.flexmailer.compose', ['mosaico_flexmail_url_filter', 'onCompose'], -1100);
        $instance->addListenerService('hook_civicrm_alterMailContent', ['mosaico_image_filter', 'alterMailContent']);
        ...
        $instance->addSubscriberServiceMap('Civi\\Api4\\Event\\Subscriber\\AutocompleteFieldSubscriber', ['civi.api.prepare' => [['onApiPrepare', -50]]]);
        ...
        $instance->addSubscriberServiceMap('Civi\\Api4\\Service\\Autocomplete\\ContactAutocompleteProvider', ['civi.search.defaultDisplay' => [['on_civi_search_defaultDisplay', 0]]]);
        ...
        $instance->addSubscriberServiceMap('Civi\\Api4\\Service\\Autocomplete\\ParticipantAutocompleteProvider', ['civi.search.defaultDisplay' => [['on_civi_search_defaultDisplay', 0]]]);
        ...
        $instance->addSubscriberServiceMap('Civi\\Api4\\Subscriber\\AfformAutocompleteSubscriber', ['civi.api.prepare' => [['onApiPrepare', -20]]]);
        ...
        $instance->addListener('civi.firewall.formprotection', [#[\Closure(name: 'civi.firewall.formprotection', class: '\\Civi\\Firewall\\Listener\\FormProtection')] fn () => ($container->services['civi.firewall.formprotection'] ??= new \Civi\Firewall\Listener\FormProtection()), 'onTrigger'], 2000);
        $instance->addListener('civi.firewall.declinedcard', [#[\Closure(name: 'civi.firewall.declinedcard', class: '\\Civi\\Firewall\\Listener\\DeclinedCard')] fn () => ($container->services['civi.firewall.declinedcard'] ??= new \Civi\Firewall\Listener\DeclinedCard()), 'onTrigger'], 2000);
        $instance->addListener('civi.firewall.fraudulentrequest', [#[\Closure(name: 'civi.firewall.fraudulentrequest', class: '\\Civi\\Firewall\\Listener\\FraudulentRequest')] fn () => ($container->services['civi.firewall.fraudulentrequest'] ??= new \Civi\Firewall\Listener\FraudulentRequest()), 'onTrigger'], 2000);
        $instance->addListener('civi.firewall.invalidcsrfrequest', [#[\Closure(name: 'civi.firewall.invalidcsrfrequest', class: '\\Civi\\Firewall\\Listener\\InvalidCSRFRequest')] fn () => ($container->services['civi.firewall.invalidcsrfrequest'] ??= new \Civi\Firewall\Listener\InvalidCSRFRequest()), 'onTrigger'], 2000);
        $instance->addListener('civi.stripe.authorize', [#[\Closure(name: 'civi.firewall.stripeauthorize', class: 'Civi\\Firewall\\Listener\\StripeAuthorize')] fn () => ($container->services['civi.firewall.stripeauthorize'] ??= new \Civi\Firewall\Listener\StripeAuthorize()), 'onStripeAuthorize'], 200);
     ...
     */
    protected static function getMosaicoAbDemuxService($container)
    {
        return $container->services['mosaico_ab_demux'] = new \CRM_Mosaico_AbDemux();
    }
     ...
     */
    protected static function getMosaicoFlexmailComposerService($container)
    {
        return $container->services['mosaico_flexmail_composer'] = new \CRM_Mosaico_MosaicoComposer();
    }
     ...
     */
    protected static function getMosaicoFlexmailUrlFilterService($container)
    {
        return $container->services['mosaico_flexmail_url_filter'] = new \CRM_Mosaico_UrlFilter();
    }
     ...
     */
    protected static function getMosaicoGraphicsService($container)
    {
        return $container->services['mosaico_graphics'] = \CRM_Mosaico_Services::createGraphics();
    }
     ...
     */
    protected static function getMosaicoImageFilterService($container)
    {
        return $container->services['mosaico_image_filter'] = new \CRM_Mosaico_ImageFilter();
    }
     ...
     */
    protected static function getMosaicoRequiredTokensService($container)
    {
        return $container->services['mosaico_required_tokens'] = new \CRM_Mosaico_MosaicoRequiredTokens();
    }
    ...
    protected static function getSpecGathererService($container)
    {
        ...
        $instance->addSpecProvider(($container->services['Civi\\Api4\\Service\\Spec\\Provider\\ACLEntityRoleCreationSpecProvider'] ??= new \Civi\Api4\Service\Spec\Provider\ACLEntityRoleCreationSpecProvider()));
        $instance->addSpecProvider(($container->services['Civi\\Api4\\Service\\Spec\\Provider\\ActionScheduleCreationSpecProvider'] ??= new \Civi\Api4\Service\Spec\Provider\ActionScheduleCreationSpecProvider()));
        ...
        $instance->addSpecProvider(($container->services['Civi\\Api4\\Service\\Spec\\Provider\\CustomGroupSpecProvider'] ??= new \Civi\Api4\Service\Spec\Provider\CustomGroupSpecProvider()));
        ...
        $instance->addSpecProvider(($container->services['Civi\\Api4\\Service\\Spec\\Provider\\UserJobSpecProvider'] ??= new \Civi\Api4\Service\Spec\Provider\UserJobSpecProvider()));
        $instance->addSpecProvider(($container->services['Civi\\Api4\\Service\\Spec\\Provider\\CampaignCreationSpecProvider'] ??= new \Civi\Api4\Service\Spec\Provider\CampaignCreationSpecProvider()));
    ...
    {
        return [
            'civicrm_base_path' => '/var/www/varbase/vendor/civicrm/civicrm-core',
        ];
    }
}
